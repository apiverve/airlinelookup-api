// Package airlinelookup provides a Go client for the Airline Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/airlinelookup?utm_source=go&utm_medium=readme
package airlinelookup
...
const (
	baseURL        = "https://api.apiverve.com/v1/airlinelookup"
	defaultTimeout = 30 * time.Second
)

// Client is the Airline Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Airline Lookup API client.
...
// Execute makes a request to the Airline Lookup API with typed parameters.
//
...
//   - iata (required): string - The IATA code of the airline for which you want to get the information (e.g., AA)
