...
```gradle
dependencies {
    implementation 'com.github.apiverve:airlinelookup-api:1.1.14'
}
```
...
```java
import com.apiverve.airlinelookup.AirlineLookupAPIClient;
import com.apiverve.airlinelookup.APIResponse;
import com.apiverve.airlinelookup.APIException;

// Initialize the client
AirlineLookupAPIClient client = new AirlineLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("iata", "AA");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/airlinelookup](https://docs.apiverve.com/ref/airlinelookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/airlinelookup](https://docs.apiverve.com/ref/airlinelookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/airlinelookup-api/issues)
