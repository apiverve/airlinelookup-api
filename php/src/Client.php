...
namespace APIVerve\Airlinelookup;
...
/**
 * Client for the Airline Lookup API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://airlinelookup.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/airlinelookup';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\AirlinelookupClient] {$message}\n";
        }
    }
}
